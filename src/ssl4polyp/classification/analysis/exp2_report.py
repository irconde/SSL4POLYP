...
def _t_critical_value(df: int, level: float) -> Optional[float]:
    """Return the two-sided Student's t critical value for ``level``."""
    ...
    try:  # pragma: no cover - SciPy optional for alternate levels
...
def compute_t_confidence_interval(
    ...
    *,
    ...
    """Compute a two-sided confidence interval for a sample mean."""
